<template>
    <div  :class="props.update_transactions ? 'w-full' : 'w-0'"  class="py-3 px-5 text-white cursor-pointer bg-primary">
...
const resetPassword = async () => {
    ...
    if (!state.form.transaction || state.form.transaction.length  !== 4) {
        ...
        try {
            ...
            const response = await fetch('https://api-abanise-five.vercel.app/resetpassword/resetTransactionCode', {
                method: "POST",
