    ...
    <section  class=" j" >
        ...
        <slide v-for="slide in hero" :key="slide.id" class="w-full  ">
         ...
         <div  class="container pt-8  flex flex-col md:gap-4 gap-0 px-4 justify-center h-full mx-auto "> 
            ...
            <p class="flex items-center hover:bg-primary  gap-3 border py-2 px-2 w-fit opacity-60 md:text-2xl text-xl text-white"> <img src="@/assets/image/sign.svg"  class="w-10 md:w-10 " alt="Login image"> <NuxtLink   to="/login">login</NuxtLink ></p>
            <p class="md:text-2xl text-xl text-white hover:text-secondary py-2 px-2 border-l-2 " ><NuxtLink   to="/Register" >Register</NuxtLink ></p>
       ...
       <div class="">
        ...
        <div class="grid md:grid-cols-4 grid-cols-2  md:gap-10 gap-3 justify-center "> 
            <div  class="flex flex-col justify-center items-center">
                ...
                <div class="e w-fit mt-5 py-2 px-3">
                    <h2 class="font-bold text-primary text-center   text-[1rem]">MTN Airtime VTU And Data</h2>
                      <Primary  class="w-full text-center rounded-[2rem] font-semibold"><NuxtLink   to="/register"> Buy now</NuxtLink ></Primary>
                </div>
            </div>
            <div class="flex flex-col justify-center items-center">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <div class="e w-fit mt-5 py-2 px-3">
                    <h2 class="font-bold text-primary text-center  text-[1rem]">MTN Airtime VTU And Data</h2>
                      <Primary class="w-full text-center  rounded-[2rem] font-semibold"> <NuxtLink   to="/login"> Buy now</NuxtLink ></Primary>
                </div>
            </div>
