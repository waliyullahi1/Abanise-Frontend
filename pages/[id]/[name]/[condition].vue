<template>
    <div class="  text-[poppins] ">
      <div class="overflow-hidden font-[Poppins]">
          ...
          <section class="container mx-auto">
            <div class="flex flex-col items-center gap-5  ">
              ...
              <div class="w-  flex flex-col gap-3">
                ...
                <div class="flex flex-col gap-5">
                  ...
                  <div>
                    ...
                    <ul class="text-sm font-semibold tracking-normal list-decimal">
                      ...
                      <li>Enter your Exam Number <span class="text-sm font-semibold" :class="wlabel ? 'block' : 'hidden'"> a
                ...
                <p class="text-xl">NOW CLICK ON THE 'PROCEED TO PAYMENT' button below to get your {{ cardName }} Scratch Card.
                </p>
                ...
                <div class="flex flex-col gap-5">
                  ...
                  <div :class="gceWaec ? 'hidden' : 'block'">
                    ...
                    <p class="text-[14px] font-semibold ">firstly All you have to do is download the software from the WAEC
                      ...
                      Fingerprint Registration software is a collection of applications that candidates must use in order to
                    ...
                    <ul class=" font-semibold text-sm tracking-normal list-decimal">
                      ...
                      <li>Depending on your hardware architecture, you will need to download either the x86 or x64 versions
                        of the RTE.</li>
                ...
                <div class="flex flex-col gap-5">
                  <div>
                    ...
                    <p class="font-semibold text-sm">It is no longer news that many graduates and PCMs face issues such as
                      incorrectly entering their Date of Birth on their NYSC Dashboards during mobilization. This frequently
                      causes them to be perplexed as to what to do next. If this is you, don't worry. It is not your fault
                      that the incorrect Date of Birth was recorded for you. I understand that you simply need to find a way
                      to correct this incorrect Date of Birth so that it does not appear on your NYSC Certificate. I have
                      some good news for you. You only need a Waec Verification Pin. You can correct this incorrect date of
        ...
        <div
          class="w-full  fixed top-0 z-20  bg-black duration-700 translate transform bg-opacity-50 items-center flex justify-center h-full px-6 md:px-0 lg:px-10"
          :class="paymentpage ? 'translate-y-0 ' : 'translate-y-[140rem]'">
          <div
            class="ul overflow-scroll mx-auto mt-20  bg-white py-5 duration-400 translate transform h-screen px-10 lg:w-1/3 md:w-1/2 w-fu ">
            ...
            <div class=" border drop-shadow-2xl py-5 px-5   rounded-xl  bg-gray-100">
              <div class="flex flex-col justify-center mb-10 items-center">
                <form action="" class=" ">
                  ...
                  <Input label="Charges" type="text" placeholder="Enter your email address" :error="false" inputValue="₦100"
                    :disabled="disabled" class="mt-4  -300"></Input>
  
                  <Input label="Total" type="Number" :min="numm" :disabled="disabled" :error="false"
                    v-model:inputValue="form.total" class="mt-4 hidden  bg-gry-300"></Input>
                  <h2 class=" mt-5"> Total</h2>
                  <div class="py-2 w-full h-10 px-5  bg-gray-300 mt-2  rounded-lg ">{{ this.form.quantity *
                    this.form.semiprice }}</div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        gceneco: "",
        gceWaec: "",
        publicKey: 'sk_live_4802abae3d44c704132695047e9cdba4a93304f4',
        amount: "",
        email: "",
        nysecard: '',
        descrption: '',
