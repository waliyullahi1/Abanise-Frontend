  ...
  <div class="  bg-blak text-[puppins] ">
    ...
    <section class="container h-screen mx-auto ">
      <div class="md:w-1/2  w-full  mx-auto   justify-center text-center 08086375698 items-center pt-[5rem] ">
        ...
        <h1 class="font-bold text-[40px] text-whte  text-[puppins] ">Thanks for your <span
            class=" text-[red]">Subscribing</span></h1>
      ...
      <div>
        <div class="mt-10">
          <div v-for="item in items" :key="item.id"
            class=" gap-10 bg-[gr  backdrop-opacity-100 py-[1px] font-semibold bg- text-xl placehold-center justify-center flex mt-2">
      ...
      <div class="flex justify-center">
        ...
        <NuxtLink to="/" class=" w-fit rounded-md text-white bg-primary py-2 px-2 ">Back to Home page </NuxtLink>
      </div>
      <p class="text-[20px] font-semibold text-primary text-center rounded-xl font-medi">If you encounter any issue while
        using this PIN, please send a mail or messages this phone number on WHATSAPP 07068393706 to within 7 days from
        now.</p>
