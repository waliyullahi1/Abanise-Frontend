  ...
  <div
    ...
    <div class="flex w-full justify-center items-center h-full  sm:mx-0 bg-black bg-opacity-70">
      <div
        ...
        <div class="bg-white h-full sm:px-10 px-5 md:max-w-md font-sans sm:w-full w-full sm:overflow-scroll relative ">
          ...
          <div class="text-center h-full justify-between w-full">
            <div class="py-5">
              ...
              <h4 class="sm:text-2xl text-xl title font-bold">Sign up to your account</h4>
              <p class="text-base">
                Dont have an account?
                <span class="text-secondary" role="button">click here</span>
              </p>
            </div>
            ...
            <transition name="slide-stagger" mode="out-in">
              <div v-if="!hidden_first_form" class="text-left inset-0 staggered-form">
                <form @submit.prevent="first_handleSubmit">
                  <LessonInput v-model:inputValue="userData[input.modelKey]" :type="input.type"
