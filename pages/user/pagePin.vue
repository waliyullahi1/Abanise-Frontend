...
// Assuming `proxies` is an array of your Proxy objects

       
          this.form = JSON.parse(localStorage.getItem('recelptlist'));
    
// this.items =JSON.parse(localStorage.getItem("cards"));
